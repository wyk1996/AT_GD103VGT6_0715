...
uint8_t YKC_SendBill(_GUN_NUM gun)
{
	...
	YKCSendCmd3B[gun].StopTime.Second = stChTcb.stCh.uiChStoptTime.ucSec * 1000;
    YKCSendCmd3B[gun].StopTime.Day = stChTcb.stCh.uiChStoptTime.ucDay;
    YKCSendCmd3B[gun].StopTime.Hour =stChTcb.stCh.uiChStoptTime.ucHour;
    YKCSendCmd3B[gun].StopTime.Minute = stChTcb.stCh.uiChStoptTime.ucMin;
    YKCSendCmd3B[gun].StopTime.Month =  stChTcb.stCh.uiChStoptTime.ucMonth;
    YKCSendCmd3B[gun].StopTime.Year = stChTcb.stCh.uiChStoptTime.ucYear - 100;
      for(i = 0; i <4;i++)
    {
